...
function Settings() {
	return (
		<div>
			<div className='container-fluid px-0 ffl-bg main-container'>
				<div className=' row py-43'>
					<div className='col-md-12'>
						<h2 className='page-title m-0 font-semi-bold'>FFL Settings</h2>
					</div>
				</div>
				<Tabs id='uncontrolled-tab-example'>
					<Tab eventKey='settings' title='Settings' className='tab'>
										...
										<FormGroup className='mr-3'>
											...
											<div className='py-50'>
												...
												<p className='f-15 font-weight-normal mb-50'>
													This cannot be undone. Prior to deleting this FFL,
													please download your files using our file exporter.
												</p>
