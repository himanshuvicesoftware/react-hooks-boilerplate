...
export default function DocumentEdit() {
	return (
		<div className='border-bottom d-flex bdr-1 bdr-secondry align-items-center bg-white'>
			...
			<div className='instruction-tool flex-fill px-25 py-10 bdr-1 bdr-secondry border-left border-right'>
				<Dropdown>
					<Dropdown.Toggle
						variant='light'
						size='block'
